...
#include "AdjointJacobianConnectivityScalarTransportFoam.H"
...
defineTypeNameAndDebug(AdjointJacobianConnectivityScalarTransportFoam, 0);
addToRunTimeSelectionTable(AdjointJacobianConnectivity, AdjointJacobianConnectivityScalarTransportFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointJacobianConnectivityScalarTransportFoam::AdjointJacobianConnectivityScalarTransportFoam
(
    const fvMesh& mesh,
