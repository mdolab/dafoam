...
#include "AdjointJacobianConnectivityTurboFoam.H"
...
defineTypeNameAndDebug(AdjointJacobianConnectivityTurboFoam, 0);
addToRunTimeSelectionTable(AdjointJacobianConnectivity, AdjointJacobianConnectivityTurboFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointJacobianConnectivityTurboFoam::AdjointJacobianConnectivityTurboFoam
(
    const fvMesh& mesh,
