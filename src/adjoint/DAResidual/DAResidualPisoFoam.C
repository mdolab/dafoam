...
defineTypeNameAndDebug(DAResidualPisoFoam, 0);
addToRunTimeSelectionTable(DAResidual, DAResidualPisoFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAResidualPisoFoam::DAResidualPisoFoam(
...
void DAResidualPisoFoam::updateIntermediateVariables()
{
    /* 
    Description:
    ...
    */
    ...
    // nothing to update for DAPisoFoam
}

void DAResidualPisoFoam::correctBoundaryConditions()
{
    /* 
    Description:
