...
#include "DAStateInfoTopoChtFoam.H"
...
defineTypeNameAndDebug(DAStateInfoTopoChtFoam, 0);
addToRunTimeSelectionTable(DAStateInfo, DAStateInfoTopoChtFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAStateInfoTopoChtFoam::DAStateInfoTopoChtFoam(
