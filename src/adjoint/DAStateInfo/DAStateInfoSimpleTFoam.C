...
#include "DAStateInfoSimpleTFoam.H"
...
defineTypeNameAndDebug(DAStateInfoSimpleTFoam, 0);
addToRunTimeSelectionTable(DAStateInfo, DAStateInfoSimpleTFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAStateInfoSimpleTFoam::DAStateInfoSimpleTFoam(
