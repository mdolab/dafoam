...
#include "DAStateInfoMySimpleTFoam.H"
...
defineTypeNameAndDebug(DAStateInfoMySimpleTFoam, 0);
addToRunTimeSelectionTable(DAStateInfo, DAStateInfoMySimpleTFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAStateInfoMySimpleTFoam::DAStateInfoMySimpleTFoam(
