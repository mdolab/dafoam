...
defineTypeNameAndDebug(DAkEpsilonRef, 0);
addToRunTimeSelectionTable(DATurbulenceModel, DAkEpsilonRef, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAkEpsilonRef::DAkEpsilonRef(
...
// KE member functions
tmp<fvScalarMatrix> DAkEpsilonRef::kSource() const
{
...
tmp<fvScalarMatrix> DAkEpsilonRef::epsilonSource() const
{
    return tmp<fvScalarMatrix>(
        new fvScalarMatrix(
            epsilon_,
...
tmp<volScalarField> DAkEpsilonRef::DkEff() const
{
...
tmp<volScalarField> DAkEpsilonRef::DepsilonEff() const
{
    return tmp<volScalarField>(
        new volScalarField(
            "DepsilonEff",
...
// Augmented functions
void DAkEpsilonRef::correctModelStates(wordList& modelStates) const
{
    /*
    Description:
...
void DAkEpsilonRef::correctBoundaryConditions()
{
    /*
    Description:
...
void DAkEpsilonRef::correctEpsilonBoundaryConditions()
{
    /*
    Description:
...
void DAkEpsilonRef::saveEpsilonNearWall()
{
    /*
    Description:
...
void DAkEpsilonRef::setEpsilonNearWall()
{
    /*
    Description:
...
void DAkEpsilonRef::updateIntermediateVariables()
{
    /*
    Description:
...
void DAkEpsilonRef::correctStateResidualModelCon(List<List<word>>& stateCon) const
{
    /*
    Description:
...
void DAkEpsilonRef::addModelResidualCon(HashTable<List<List<word>>>& allCon) const
{
    /*
    Description:
...
void DAkEpsilonRef::correct(label printToScreen)
{
    /*
    Descroption:
...
void DAkEpsilonRef::calcResiduals(const dictionary& options)
{
    /*
    Descroption:
...
void DAkEpsilonRef::getFvMatrixFields(
    const word varName,
    scalarField& diag,
    scalarField& upper,
    scalarField& lower)
...
void DAkEpsilonRef::getTurbProdOverDestruct(scalarList& PoD) const
{
    /*
    Description:
...
void DAkEpsilonRef::getTurbConvOverProd(scalarList& CoP) const
{
    /*
    Description:
