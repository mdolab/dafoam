...
#include "DASpalartAllmarasFieldInversion.H"
...
defineTypeNameAndDebug(DASpalartAllmarasFieldInversion, 0);
...
// src/TurbulenceModels/turbulenceModels/RAS/SpalartAllmarasFieldInversion/SpalartAllmarasFieldInversion.C
tmp<volScalarField> DASpalartAllmarasFieldInversion::chi() const
{
    return nuTilda_ / this->nu();
}

tmp<volScalarField> DASpalartAllmarasFieldInversion::fv1(
...
tmp<volScalarField> DASpalartAllmarasFieldInversion::fv2(
...
tmp<volScalarField> DASpalartAllmarasFieldInversion::Stilda(
    const volScalarField& chi,
    const volScalarField& fv1) const
{
...
tmp<volScalarField> DASpalartAllmarasFieldInversion::fw(
...
tmp<volScalarField> DASpalartAllmarasFieldInversion::DnuTildaEff() const
{
...
// Augmented functions
void DASpalartAllmarasFieldInversion::correctModelStates(wordList& modelStates) const
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversion::correctNut()
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversion::correctBoundaryConditions()
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversion::updateIntermediateVariables()
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversion::correctStateResidualModelCon(List<List<word>>& stateCon) const
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversion::addModelResidualCon(HashTable<List<List<word>>>& allCon) const
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversion::correct()
{
    /*
    Descroption:
...
void DASpalartAllmarasFieldInversion::calcResiduals(const dictionary& options)
{
    /*
    Descroption:
