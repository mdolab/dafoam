...
#include "DAkOmegaFieldInversionk.H"
...
defineTypeNameAndDebug(DAkOmegaFieldInversionk, 0);
addToRunTimeSelectionTable(DATurbulenceModel, DAkOmegaFieldInversionk, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAkOmegaFieldInversionk::DAkOmegaFieldInversionk(
...
// Augmented functions
void DAkOmegaFieldInversionk::correctModelStates(wordList& modelStates) const
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::correctNut()
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::correctBoundaryConditions()
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::correctOmegaBoundaryConditions()
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::saveOmegaNearWall()
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::setOmegaNearWall()
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::updateIntermediateVariables()
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::correctStateResidualModelCon(List<List<word>>& stateCon) const
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::addModelResidualCon(HashTable<List<List<word>>>& allCon) const
{
    /*
    Description:
...
void DAkOmegaFieldInversionk::correct()
{
    /*
    Descroption:
...
void DAkOmegaFieldInversionk::calcResiduals(const dictionary& options)
{
    /*
    Descroption:
    ...
    */
    ...
    volScalarField G("kOmegaFieldInversionk:G", nut_ * (tgradU() && dev(twoSymm(tgradU()))));
    tgradU.clear();
