...
#include "DASpalartAllmarasDataAssimilation.H"
...
defineTypeNameAndDebug(DASpalartAllmarasDataAssimilation, 0);
addToRunTimeSelectionTable(DATurbulenceModel, DASpalartAllmarasDataAssimilation, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DASpalartAllmarasDataAssimilation::DASpalartAllmarasDataAssimilation(
    ...
    : DATurbulenceModel(modelType, mesh, daOption),
      ...
      nuTildaResPartDeriv_(
          IOobject(
              ...
              IOobject::NO_WRITE),
          nuTildaRes_),
      betaDataAssimilation_(const_cast<volScalarField&>(
          mesh.thisDb().lookupObject<volScalarField>("betaDataAssimilation"))),
...
tmp<volScalarField> DASpalartAllmarasDataAssimilation::chi() const
{
    return nuTilda_ / this->nu();
}

tmp<volScalarField> DASpalartAllmarasDataAssimilation::fv1(
...
tmp<volScalarField> DASpalartAllmarasDataAssimilation::fv2(
...
tmp<volScalarField> DASpalartAllmarasDataAssimilation::Stilda(
    const volScalarField& chi,
    const volScalarField& fv1) const
{
...
tmp<volScalarField> DASpalartAllmarasDataAssimilation::fw(
...
tmp<volScalarField> DASpalartAllmarasDataAssimilation::DnuTildaEff() const
{
...
// Augmented functions
void DASpalartAllmarasDataAssimilation::correctModelStates(wordList& modelStates) const
{
    /*
    Description:
...
void DASpalartAllmarasDataAssimilation::correctNut()
{
    /*
    Description:
...
void DASpalartAllmarasDataAssimilation::correctBoundaryConditions()
{
    /*
    Description:
...
void DASpalartAllmarasDataAssimilation::updateIntermediateVariables()
{
    /*
    Description:
...
void DASpalartAllmarasDataAssimilation::correctStateResidualModelCon(List<List<word>>& stateCon) const
{
    /*
    Description:
...
void DASpalartAllmarasDataAssimilation::addModelResidualCon(HashTable<List<List<word>>>& allCon) const
{
    /*
    Description:
...
void DASpalartAllmarasDataAssimilation::correct(label printToScreen)
{
    /*
    Descroption:
...
void DASpalartAllmarasDataAssimilation::calcResiduals(const dictionary& options)
{
    /*
    Descroption:
    ...
    */
    ...
    tmp<fvScalarMatrix> nuTildaEqn(
        ...
        == Cb1_ * phase_ * rho_ * Stilda * nuTilda_ + nuTilda_ * nuTilda_ * betaDataAssimilation_
...
void DASpalartAllmarasDataAssimilation::getTurbProdTerm(scalarList& prodTerm) const
{
    /*
    Description:
