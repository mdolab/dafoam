...
#include "DASpalartAllmarasFieldInversionT.H"
...
defineTypeNameAndDebug(DASpalartAllmarasFieldInversionT, 0);
addToRunTimeSelectionTable(DATurbulenceModel, DASpalartAllmarasFieldInversionT, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DASpalartAllmarasFieldInversionT::DASpalartAllmarasFieldInversionT(
    ...
    : DATurbulenceModel(modelType, mesh, daOption),
      ...
      TData_(const_cast<volScalarField&>(
          mesh.thisDb().lookupObject<volScalarField>("TData"))),
...
tmp<volScalarField> DASpalartAllmarasFieldInversionT::chi() const
{
    return nuTilda_ / this->nu();
}

tmp<volScalarField> DASpalartAllmarasFieldInversionT::fv1(
...
tmp<volScalarField> DASpalartAllmarasFieldInversionT::fv2(
...
tmp<volScalarField> DASpalartAllmarasFieldInversionT::Stilda(
    const volScalarField& chi,
    const volScalarField& fv1) const
{
...
tmp<volScalarField> DASpalartAllmarasFieldInversionT::fw(
...
tmp<volScalarField> DASpalartAllmarasFieldInversionT::DnuTildaEff() const
{
...
// Augmented functions
void DASpalartAllmarasFieldInversionT::correctModelStates(wordList& modelStates) const
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversionT::correctNut()
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversionT::correctBoundaryConditions()
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversionT::updateIntermediateVariables()
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversionT::correctStateResidualModelCon(List<List<word>>& stateCon) const
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversionT::addModelResidualCon(HashTable<List<List<word>>>& allCon) const
{
    /*
    Description:
...
void DASpalartAllmarasFieldInversionT::correct(label printToScreen)
{
    /*
    Descroption:
...
void DASpalartAllmarasFieldInversionT::calcResiduals(const dictionary& options)
{
    /*
    Descroption:
...
void DASpalartAllmarasFieldInversionT::getTurbProdTerm(scalarList& prodTerm) const
{
    /*
    Description:
