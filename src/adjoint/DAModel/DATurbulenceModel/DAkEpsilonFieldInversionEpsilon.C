...
#include "DAkEpsilonFieldInversionEpsilon.H"
...
defineTypeNameAndDebug(DAkEpsilonFieldInversionEpsilon, 0);
addToRunTimeSelectionTable(DATurbulenceModel, DAkEpsilonFieldInversionEpsilon, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAkEpsilonFieldInversionEpsilon::DAkEpsilonFieldInversionEpsilon(
...
// KE member functions
tmp<fvScalarMatrix> DAkEpsilonFieldInversionEpsilon::kSource() const
{
...
tmp<fvScalarMatrix> DAkEpsilonFieldInversionEpsilon::epsilonSource() const
{
    return tmp<fvScalarMatrix>(
        new fvScalarMatrix(
            epsilon_,
...
tmp<volScalarField> DAkEpsilonFieldInversionEpsilon::DkEff() const
{
...
tmp<volScalarField> DAkEpsilonFieldInversionEpsilon::DepsilonEff() const
{
    return tmp<volScalarField>(
        new volScalarField(
            "DepsilonEff",
...
// Augmented functions
void DAkEpsilonFieldInversionEpsilon::correctModelStates(wordList& modelStates) const
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::correctNut()
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::correctBoundaryConditions()
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::correctEpsilonBoundaryConditions()
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::saveEpsilonNearWall()
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::setEpsilonNearWall()
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::updateIntermediateVariables()
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::correctStateResidualModelCon(List<List<word>>& stateCon) const
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::addModelResidualCon(HashTable<List<List<word>>>& allCon) const
{
    /*
    Description:
...
void DAkEpsilonFieldInversionEpsilon::correct()
{
    /*
    Descroption:
...
void DAkEpsilonFieldInversionEpsilon::calcResiduals(const dictionary& options)
{
    /*
    Descroption:
    ...
    */
    ...
    volScalarField::Internal G(
        "kEpsilonFieldInversionEpsilon:G",
    ...
    tmp<fvScalarMatrix> epsEqn(
        ...
        == C1_ * phase_() * rho_() * G * epsilon_() / k_() * betaFieldInversion_
