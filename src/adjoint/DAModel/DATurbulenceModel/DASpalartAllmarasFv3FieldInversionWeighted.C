...
#include "DASpalartAllmarasFv3FieldInversionWeighted.H"
...
defineTypeNameAndDebug(DASpalartAllmarasFv3FieldInversionWeighted, 0);
addToRunTimeSelectionTable(DATurbulenceModel, DASpalartAllmarasFv3FieldInversionWeighted, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DASpalartAllmarasFv3FieldInversionWeighted::DASpalartAllmarasFv3FieldInversionWeighted(
    ...
    : DATurbulenceModel(modelType, mesh, daOption),
      ...
      weightsObjFunc_(const_cast<volScalarField&>(
          mesh.thisDb().lookupObject<volScalarField>("weightsObjFunc"))),
...
tmp<volScalarField> DASpalartAllmarasFv3FieldInversionWeighted::chi() const
{
    return nuTilda_ / this->nu();
}

tmp<volScalarField> DASpalartAllmarasFv3FieldInversionWeighted::fv1(
...
tmp<volScalarField> DASpalartAllmarasFv3FieldInversionWeighted::fv2(
...
tmp<volScalarField> DASpalartAllmarasFv3FieldInversionWeighted::fv3(
    const volScalarField& chi,
    const volScalarField& fv1) const
{
...
tmp<volScalarField> DASpalartAllmarasFv3FieldInversionWeighted::fw(
...
tmp<volScalarField> DASpalartAllmarasFv3FieldInversionWeighted::DnuTildaEff() const
{
...
// Augmented functions
void DASpalartAllmarasFv3FieldInversionWeighted::correctModelStates(wordList& modelStates) const
{
    /*
    Description:
...
void DASpalartAllmarasFv3FieldInversionWeighted::correctNut()
{
    /*
    Description:
...
void DASpalartAllmarasFv3FieldInversionWeighted::correctBoundaryConditions()
{
    /*
    Description:
...
void DASpalartAllmarasFv3FieldInversionWeighted::updateIntermediateVariables()
{
    /*
    Description:
...
void DASpalartAllmarasFv3FieldInversionWeighted::correctStateResidualModelCon(List<List<word>>& stateCon) const
{
    /*
    Description:
...
void DASpalartAllmarasFv3FieldInversionWeighted::addModelResidualCon(HashTable<List<List<word>>>& allCon) const
{
    /*
    Description:
...
void DASpalartAllmarasFv3FieldInversionWeighted::correct()
{
    /*
    Descroption:
...
void DASpalartAllmarasFv3FieldInversionWeighted::calcResiduals(const dictionary& options)
{
    /*
    Descroption:
...
void DASpalartAllmarasFv3FieldInversionWeighted::getTurbProdTerm(scalarList& prodTerm) const
{
    /*
    Description:
