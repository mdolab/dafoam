...
void kOmegaSSTSR<BasicTurbulenceModel>::correctNut()
{
}
...
template<class BasicTurbulenceModel>
kOmegaSSTSR<BasicTurbulenceModel>::kOmegaSSTSR(
...
template<class BasicTurbulenceModel>
bool kOmegaSSTSR<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kOmegaSSTSR<BasicTurbulenceModel>::k() const
{
    return this->nut_;
}

template<class BasicTurbulenceModel>
tmp<volScalarField> kOmegaSSTSR<BasicTurbulenceModel>::epsilon() const
{
    return this->nut_;
}

template<class BasicTurbulenceModel>
void kOmegaSSTSR<BasicTurbulenceModel>::correct()
{
}
