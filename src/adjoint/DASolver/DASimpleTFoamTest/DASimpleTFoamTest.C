...
defineTypeNameAndDebug(DASimpleTFoamTest, 0);
addToRunTimeSelectionTable(DASolver, DASimpleTFoamTest, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DASimpleTFoamTest::DASimpleTFoamTest(
    char* argsAll,
    PyObject* pyOptions)
...
void DASimpleTFoamTest::initSolver()
{
    /*
    Description:
...
#include "createFieldsSimpleTTest.H"
...
label DASimpleTFoamTest::solvePrimal(
    const Vec xvVec,
    Vec wVec)
{
    /*
...
#include "createRefsSimpleTTest.H"
    ...
    while (this->loop(runTime)) // using simple.loop() will have seg fault in parallel
    {
        ...
        {
#include "UEqnSimpleTTest.H"
#include "pEqnSimpleTTest.H"
#include "TEqnSimpleTTest.H"
        }
