...
#include "DAObjFuncFieldInversionT.H"
...
defineTypeNameAndDebug(DAObjFuncFieldInversionT, 0);
addToRunTimeSelectionTable(DAObjFunc, DAObjFuncFieldInversionT, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAObjFuncFieldInversionT::DAObjFuncFieldInversionT(
    const fvMesh& mesh,
...
void DAObjFuncFieldInversionT::calcObjFunc(
