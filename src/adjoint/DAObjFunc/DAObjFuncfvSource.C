...
defineTypeNameAndDebug(DAObjFuncfvSource, 0);
addToRunTimeSelectionTable(DAObjFunc, DAObjFuncfvSource, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAObjFuncfvSource::DAObjFuncfvSource(
    const fvMesh& mesh,
...
void DAObjFuncfvSource::calcObjFunc(
