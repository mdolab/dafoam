...
\*---------------------------------------------------------------------------*/
#include "ColoringSolverIncompressible.H"
...
// Constructors
ColoringSolverIncompressible::ColoringSolverIncompressible(char* argsAll)
{
    argsAll_ = argsAll;
}

ColoringSolverIncompressible::~ColoringSolverIncompressible()
{
}

void ColoringSolverIncompressible::run()
{
    #include "setArgs.H"
