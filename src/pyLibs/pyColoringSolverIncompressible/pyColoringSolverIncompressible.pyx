...
# distutils: sources = ColoringSolverIncompressible.C
...
cdef extern from "ColoringSolverIncompressible.H" namespace "Foam":
    cppclass ColoringSolverIncompressible:
        ColoringSolverIncompressible(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pyColoringSolverIncompressible:

    # define a class pointer for cpp functions
    cdef:
        ColoringSolverIncompressible * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new ColoringSolverIncompressible(argsAll)
