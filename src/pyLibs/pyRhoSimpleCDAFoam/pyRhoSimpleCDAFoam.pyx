...
# distutils: sources = RhoSimpleCDAFoam.C
...
cdef extern from "RhoSimpleCDAFoam.H" namespace "Foam":
    cppclass RhoSimpleCDAFoam:
        RhoSimpleCDAFoam(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pyRhoSimpleCDAFoam:

    # define a class pointer for cpp functions
    cdef:
        RhoSimpleCDAFoam * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new RhoSimpleCDAFoam(argsAll)
