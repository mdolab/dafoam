...
# distutils: sources = BuoyantSimpleDAFoam.C
...
cdef extern from "BuoyantSimpleDAFoam.H" namespace "Foam":
    cppclass BuoyantSimpleDAFoam:
        BuoyantSimpleDAFoam(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pyBuoyantSimpleDAFoam:

    # define a class pointer for cpp functions
    cdef:
        BuoyantSimpleDAFoam * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new BuoyantSimpleDAFoam(argsAll)
