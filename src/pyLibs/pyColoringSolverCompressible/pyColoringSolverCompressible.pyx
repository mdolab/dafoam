...
# distutils: sources = ColoringSolverCompressible.C
...
cdef extern from "ColoringSolverCompressible.H" namespace "Foam":
    cppclass ColoringSolverCompressible:
        ColoringSolverCompressible(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pyColoringSolverCompressible:

    # define a class pointer for cpp functions
    cdef:
        ColoringSolverCompressible * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new ColoringSolverCompressible(argsAll)
