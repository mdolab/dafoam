...
# distutils: sources = SimpleDAFoam.C
...
cdef extern from "SimpleDAFoam.H" namespace "Foam":
    cppclass SimpleDAFoam:
        SimpleDAFoam(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pySimpleDAFoam:

    # define a class pointer for cpp functions
    cdef:
        SimpleDAFoam * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new SimpleDAFoam(argsAll)
