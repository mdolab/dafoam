...
# distutils: sources = SolidDisplacementDAFoam.C
...
cdef extern from "SolidDisplacementDAFoam.H" namespace "Foam":
    cppclass SolidDisplacementDAFoam:
        SolidDisplacementDAFoam(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pySolidDisplacementDAFoam:

    # define a class pointer for cpp functions
    cdef:
        SolidDisplacementDAFoam * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new SolidDisplacementDAFoam(argsAll)
