...
# distutils: sources = BuoyantBoussinesqSimpleDAFoam.C
...
cdef extern from "BuoyantBoussinesqSimpleDAFoam.H" namespace "Foam":
    cppclass BuoyantBoussinesqSimpleDAFoam:
        BuoyantBoussinesqSimpleDAFoam(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pyBuoyantBoussinesqSimpleDAFoam:

    # define a class pointer for cpp functions
    cdef:
        BuoyantBoussinesqSimpleDAFoam * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new BuoyantBoussinesqSimpleDAFoam(argsAll)
