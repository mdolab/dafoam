...
# distutils: sources = RhoSimpleDAFoam.C
...
cdef extern from "RhoSimpleDAFoam.H" namespace "Foam":
    cppclass RhoSimpleDAFoam:
        RhoSimpleDAFoam(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pyRhoSimpleDAFoam:

    # define a class pointer for cpp functions
    cdef:
        RhoSimpleDAFoam * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new RhoSimpleDAFoam(argsAll)
