...
# distutils: sources = TurboDAFoam.C
...
cdef extern from "TurboDAFoam.H" namespace "Foam":
    cppclass TurboDAFoam:
        TurboDAFoam(char*) except +
        void run()

# create python wrappers that call cpp functions
cdef class pyTurboDAFoam:

    # define a class pointer for cpp functions
    cdef:
        TurboDAFoam * _thisptr
    ...
    def __init__(self, argsAll):
        ...
        '''
        self._thisptr = new TurboDAFoam(argsAll)
