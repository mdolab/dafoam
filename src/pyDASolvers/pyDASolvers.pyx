...
cdef extern from "DASolvers.H" namespace "Foam":
    cppclass DASolvers:
        ...
        # Uttam 20251114
        void calcdRdFieldTPsiAD_Coarse(PetscVec, PetscVec, PetscVec, char *, PetscVec)
        void calcdFdFieldAD(PetscVec, PetscVec, char *, char *, PetscVec)
        # Uttam 20251114
        void calcdFdFieldAD_Coarse(PetscVec, PetscVec, char *, char *, PetscVec)
        ...
        # Uttam 20251111
        int getGlobalXvIndex_Coarse(int, int)
        void ofField2StateVec(PetscVec)
        # Uttam 20251107
        void ofField2StateVec_Coarse(PetscVec)
        void stateVec2OFField(PetscVec)
        int getNLocalAdjointStates()
        # Uttam 20251107
        int getNLocalAdjointStates_Coarse()
        int getNLocalAdjointBoundaryStates()
        int getNLocalCells()
        # Uttam 20251114
        int getNLocalCells_Coarse()
        int getNLocalPoints()
        ...
        # Uttam 20251114
        void getOFField_Coarse(char *, char *, PetscVec)
        ...
        # Uttam 20251114
        void setFieldValue4GlobalCellI_Coarse(char *, double, int, int)
        ...
        # Uttam 20251114
        void writeSensMapField_Coarse(char *, double *, char *, double)
        double getLatestTime()
        #20250916
        int getNLocalFaces(char *)
        #20251029
        int getNlocalSubDomainCells(char *)
        #20251029
        void registerCellSet(char *)
...
cdef class pyDASolvers:
    ...
    # Uttam 20251111
    def interpolateControlToTarget(self):
        self._thisptr.interpolateControlToTarget()
        
    # Uttam 20251114
    def interpolateStateToTarget(self):
        self._thisptr.interpolateStateToTarget()
    ...
    def calcdRdWT_Coarse(self, Vec xvVec, Vec wVec, isPC, Mat dRdWT):
        self._thisptr.calcdRdWT_Coarse(xvVec.vec, wVec.vec, isPC, dRdWT.mat)
    ...
    def initializedRdWTMatrixFree_Coarse(self, Vec xvVec, Vec wVec):
        self._thisptr.initializedRdWTMatrixFree_Coarse(xvVec.vec, wVec.vec)
    
    def destroydRdWTMatrixFree(self):
        self._thisptr.destroydRdWTMatrixFree()
        
    def destroydRdWTMatrixFree_Coarse(self):
        self._thisptr.destroydRdWTMatrixFree_Coarse()
    ...
    # Uttam 20251113
    def calcdFdWAD_Coarse(self, Vec xvVec, Vec wVec, objFuncName, Vec dFdW):
        self._thisptr.calcdFdWAD_Coarse(xvVec.vec, wVec.vec, objFuncName, dFdW.vec)
    ...
    # Uttam 20251111
    def createMLRKSPMatrixFree_Coarse(self, Mat jacPCMat, KSP myKSP):
        self._thisptr.createMLRKSPMatrixFree_Coarse(jacPCMat.mat, myKSP.ksp)
    ...
    # Uttam 20251111
    def solveLinearEqn_Coarse(self, KSP myKSP, Vec rhsVec, Vec solVec):
        self._thisptr.solveLinearEqn_Coarse(myKSP.ksp, rhsVec.vec, solVec.vec)
    ...
    # Uttam 20251114
    def calcdRdFieldTPsiAD_Coarse(self, Vec xvVec, Vec wVec, Vec psiVec, designVarName, Vec dRdFieldTPsi):
        self._thisptr.calcdRdFieldTPsiAD_Coarse(xvVec.vec, wVec.vec, psiVec.vec, designVarName, dRdFieldTPsi.vec)
    ...
    # Uttam 20251114
    def calcdFdFieldAD_Coarse(self, Vec xvVec, Vec wVec, objFuncName, designVarName, Vec dFdField):
        self._thisptr.calcdFdFieldAD_Coarse(xvVec.vec, wVec.vec, objFuncName, designVarName, dFdField.vec)
    ...
    # Uttam 20251111
    def getGlobalXvIndex_Coarse(self, pointI, coordI):
        return self._thisptr.getGlobalXvIndex_Coarse(pointI, coordI)
    
    def ofField2StateVec(self, Vec stateVec):
        self._thisptr.ofField2StateVec(stateVec.vec)
        
    # Uttam 20251107
    def ofField2StateVec_Coarse(self, Vec stateVec):
        self._thisptr.ofField2StateVec_Coarse(stateVec.vec)
    ...
    # Uttam 20251107
    def getNLocalAdjointStates_Coarse(self):
        return self._thisptr.getNLocalAdjointStates_Coarse()
    ...
    def getNLocalCells_Coarse(self):
        return self._thisptr.getNLocalCells_Coarse()
    
    #20250916
    def getNLocalFaces(self, patchName):
        return self._thisptr.getNLocalFaces(patchName)
    #20251029
    #def getNlocalSubDomainCells(self, name):
    #    return self._thisptr.getNlocalSubDomainCells(name)
    #20251029
    #def registerCellSet(self, name):
    #    return self._thisptr.registerCellSet(name)
    ...
    # Uttam 20251114
    def getOFField_Coarse(self, fieldName, fieldType, Vec fieldVec):
        self._thisptr.getOFField_Coarse(fieldName, fieldType, fieldVec.vec)
    ...
    def setFieldValue4GlobalCellI_Coarse(self, fieldName, val, globalCellI, compI = 0):
        self._thisptr.setFieldValue4GlobalCellI_Coarse(fieldName, val, globalCellI, compI)
    ...
    # Uttam 20251114
    def writeSensMapField_Coarse(self, 
            name,
            np.ndarray[double, ndim=1, mode="c"] dFdField,
            fieldType,
            timeName):
        
        nCells = self.getNLocalCells_Coarse()
        if fieldType == "scalar":
            assert len(dFdField) == nCells, "invalid array size!"
        elif fieldType == "vector":
            assert len(dFdField) == 3 * nCells, "invalid array size!"
        ...
        self._thisptr.writeSensMapField_Coarse(
            name.encode(), 
            dFdField_data, 
            fieldType.encode(), 
            timeName)
