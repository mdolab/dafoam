...
cdef extern from "DASolvers.H" namespace "Foam":
    cppclass DASolvers:
        ...
        void calcdAcousticsdXvAD(PetscVec, PetscVec, PetscVec, PetscVec, char*)
        void calcdRdActTPsiAD(PetscVec, PetscVec, PetscVec, char*, PetscVec)
        void calcdForcedWAD(PetscVec, PetscVec, PetscVec, PetscVec)
        void calcdAcousticsdWAD(PetscVec, PetscVec, PetscVec, PetscVec, char*)
        ...
        void getAcousticData(PetscVec, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec)
...
cdef class pyDASolvers:
    ...
    def calcdAcousticsdXvAD(self, Vec xvVec, Vec wVec, Vec fBarVec, Vec dAcoudXv, varName):
        self._thisptr.calcdAcousticsdXvAD(xvVec.vec, wVec.vec, fBarVec.vec, dAcoudXv.vec, varName)
    ...
    def calcdAcousticsdWAD(self, Vec xvVec, Vec wVec, Vec fBarVec, Vec dAcoudW, varName):
        self._thisptr.calcdAcousticsdWAD(xvVec.vec, wVec.vec, fBarVec.vec, dAcoudW.vec, varName) 
    ...
    def getAcousticData(self, Vec x, Vec y, Vec z, Vec nX, Vec nY, Vec nZ, Vec a, Vec fX, Vec fY, Vec fZ):
        self._thisptr.getAcousticData(x.vec, y.vec, z.vec, nX.vec, nY.vec, nZ.vec, a.vec, fX.vec, fY.vec, fZ.vec)
