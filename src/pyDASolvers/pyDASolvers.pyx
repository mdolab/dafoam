...
cdef extern from "DASolvers.H" namespace "Foam":
    cppclass DASolvers:
        ...
        void calcdFvSourcedInputsTPsiAD(char *, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec, PetscVec)
...
cdef class pyDASolvers:
    ...
    def calcdFvSourcedInputsTPsiAD(self, mode, Vec aForce, Vec tForce, Vec rDistExt, Vec targetForce, Vec center, Vec fvSource, Vec psi, Vec dFvSource):
        self._thisptr.calcdFvSourcedInputsTPsiAD(mode, aForce.vec, tForce.vec, rDistExt.vec, targetForce.vec, center.vec, fvSource.vec, psi.vec, dFvSource.vec)
