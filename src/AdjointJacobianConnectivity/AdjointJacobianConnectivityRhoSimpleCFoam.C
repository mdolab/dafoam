...
#include "AdjointJacobianConnectivityRhoSimpleCFoam.H"
...
defineTypeNameAndDebug(AdjointJacobianConnectivityRhoSimpleCFoam, 0);
addToRunTimeSelectionTable(AdjointJacobianConnectivity, AdjointJacobianConnectivityRhoSimpleCFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointJacobianConnectivityRhoSimpleCFoam::AdjointJacobianConnectivityRhoSimpleCFoam
(
    const fvMesh& mesh,
