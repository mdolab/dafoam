...
#include "AdjointSolverRegistrySimpleTFoam.H"
...
defineTypeNameAndDebug(AdjointSolverRegistrySimpleTFoam, 0);
addToRunTimeSelectionTable(AdjointSolverRegistry, AdjointSolverRegistrySimpleTFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointSolverRegistrySimpleTFoam::AdjointSolverRegistrySimpleTFoam
(
    const fvMesh& mesh
)
    :
