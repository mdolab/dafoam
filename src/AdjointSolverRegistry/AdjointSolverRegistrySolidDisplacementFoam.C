...
#include "AdjointSolverRegistrySolidDisplacementFoam.H"
...
defineTypeNameAndDebug(AdjointSolverRegistrySolidDisplacementFoam, 0);
addToRunTimeSelectionTable(AdjointSolverRegistry, AdjointSolverRegistrySolidDisplacementFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointSolverRegistrySolidDisplacementFoam::AdjointSolverRegistrySolidDisplacementFoam
(
    const fvMesh& mesh
)
    :
