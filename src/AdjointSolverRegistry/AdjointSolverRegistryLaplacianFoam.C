...
#include "AdjointSolverRegistryLaplacianFoam.H"
...
defineTypeNameAndDebug(AdjointSolverRegistryLaplacianFoam, 0);
addToRunTimeSelectionTable(AdjointSolverRegistry, AdjointSolverRegistryLaplacianFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointSolverRegistryLaplacianFoam::AdjointSolverRegistryLaplacianFoam
(
    const fvMesh& mesh
)
    :
