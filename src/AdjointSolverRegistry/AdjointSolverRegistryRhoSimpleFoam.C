...
#include "AdjointSolverRegistryRhoSimpleFoam.H"
...
defineTypeNameAndDebug(AdjointSolverRegistryRhoSimpleFoam, 0);
addToRunTimeSelectionTable(AdjointSolverRegistry, AdjointSolverRegistryRhoSimpleFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointSolverRegistryRhoSimpleFoam::AdjointSolverRegistryRhoSimpleFoam
(
    const fvMesh& mesh
)
    :
