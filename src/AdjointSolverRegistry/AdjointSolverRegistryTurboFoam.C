...
#include "AdjointSolverRegistryTurboFoam.H"
...
defineTypeNameAndDebug(AdjointSolverRegistryTurboFoam, 0);
addToRunTimeSelectionTable(AdjointSolverRegistry, AdjointSolverRegistryTurboFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointSolverRegistryTurboFoam::AdjointSolverRegistryTurboFoam
(
    const fvMesh& mesh
)
    :
