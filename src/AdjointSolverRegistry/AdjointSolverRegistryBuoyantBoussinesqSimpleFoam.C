...
#include "AdjointSolverRegistryBuoyantBoussinesqSimpleFoam.H"
...
defineTypeNameAndDebug(AdjointSolverRegistryBuoyantBoussinesqSimpleFoam, 0);
addToRunTimeSelectionTable(AdjointSolverRegistry, AdjointSolverRegistryBuoyantBoussinesqSimpleFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointSolverRegistryBuoyantBoussinesqSimpleFoam::AdjointSolverRegistryBuoyantBoussinesqSimpleFoam
(
    const fvMesh& mesh
)
    :
