...
class PYDAFOAM(AeroSolver):
    ...
    def _getDefOptions(self):
        ...
        defOpts = { # a special key to add/modify default dictionary without explicitly write them all 
                    ...
                    'normalizeresiduals':[list,['URes','pRes','p_rghRes','phiRes','TRes','nuTildaRes','kRes','omegaRes','epsilonRes','ReThetatRes','gammaIntRes','GRes','DRes','v2Res','fRes']],
                    'normalizestates':[list,['U','p','p_rgh','phi','T','nuTilda','k','omega','epsilon','ReThetat','gammaInt','G','D','v2','f']],
                    'maxresconlv4jacpcmat':[dict,{'URes':2,'pRes':2,'p_rghRes':2,'phiRes':1,'nuTildaRes':2,'kRes':2,'omegaRes':2,'epsilonRes':2,'ReThetatRes':2,'gammaIntRes':2,'TRes':2,'eRes':2,'GRes':2,'DRes':2,'v2Res':2,'fRes':2}],
                    'statescaling':[dict,{}],
                    'residualscaling':[dict,{}],
                    'nffdpoints':[int,0],
