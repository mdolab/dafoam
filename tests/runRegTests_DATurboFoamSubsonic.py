...
daOptions = {
    ...
    "primalFuncStdTol": {"stdTol": 3e-12, "slopeTol": 3e-12, "funcNames": ["TPR"], "nStepsFrac": 0.108},
    "primalBC": {
...
if gcomm.rank == 0:
    ...
    derivDict = {}
    derivDict["TPR"] = {}
    derivDict["TPR"]["shape-Adjoint"] = results[("cruise.aero_post.TPR", "shape")]["J_rev"][0]
    derivDict["TPR"]["shape-FD"] = results[("cruise.aero_post.TPR", "shape")]["J_fd"][0]
    derivDict["CMZ"] = {}
    derivDict["CMZ"]["shape-Adjoint"] = results[("cruise.aero_post.CMZ", "shape")]["J_rev"][0]
